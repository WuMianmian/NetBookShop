...
@implementation WhiteWaterWaveView
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
//        self.backgroundColor = rgba(40, 43, 53,1.0);
...
- (void)ConfigParams
{
    ...
    _waterWaveHeight = 160;
    _waveColor = rgba(101, 101, 109,0.1);
